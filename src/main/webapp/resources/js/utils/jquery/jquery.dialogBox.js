/*!
 * dialogBox 0.1.1
 * from http://www.jq22.com/jquery-info4822 
 * 使用文档参考原作者
 */
;(function ($, window, document, undefined) {
    ...
    DialogBox.prototype = {
        ...
        render: function () {
            ...
            $('body').append(dialogHTML[0] + dialogHTML[1]);
                    ...
                    .on('load', function () {
                        ...
                        if (that.settings.autoSize) {
                            ...
                            $dialogBox.css({
                                ...
                                height: function () {
                                    if (type === '' || type === 'dialog-normal') {
                                        return dialogBoxHeight + 'px';
                                    } else if (type === 'dialog-error' || type === 'dialog-correct') {
        ...
        show: function () {
            ...
            setTimeout(function () {
                $('.dialog-box').addClass('dialog-show');
            }, 50)
...
// 			},150)
        ...
        setStyle: function () {
            ...
            switch (that.settings.type) {
                case 'dialog-correct':
                    $container.addClass('dialog-correct');
                    break;
                case 'dialog-error':
                    $container.addClass('dialog-error');
                    break;
                default:
                    $container.addClass('dialog-normal');
                    ;
                    break;
            }
...
// 				that.hide();
// 			});
            $('.dialog-box-close,#dialog-box-mask,.dialog-btn-cancel').on('click', function () {
                that.hide();
            });
...
//            	dialogBox= new DialogBox(this, options);
//                $.data(this, "plugin_" + pluginName,dialogBox);			
//			}else{
//				dialogBox=$.data(this, "plugin_dialogBox");
//            }
//        });
//		return dialogBox;
//    }
